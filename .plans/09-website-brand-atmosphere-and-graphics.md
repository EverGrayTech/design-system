...
- Reduces ambiguity around gradients, glow, graphic motifs, and motion restraint on marketing surfaces
- Protects clarity, accessibility, and structure while allowing the website expression to be more cinematic than applications

## Scope Decisions (Locked)
- This plan covers website-only atmospheric treatments and graphic posture, not application-surface motion or decorative effects for operational products
- Guidance defines acceptable patterns and boundaries rather than mandating one exact hero treatment or animation implementation
- Atmosphere must always remain secondary to structure, typography, and content readability
- Any tokenization of atmosphere-related intensity should be introduced only if it clearly improves cross-site consistency
- Reduced-motion and contrast preservation are first-class requirements for all atmospheric treatments
